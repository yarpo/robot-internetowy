...
public class RobotinternetowyAboutBox extends javax.swing.JDialog
{
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(robotinternetowy.RobotinternetowyApp.class).getContext().getResourceMap(RobotinternetowyAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(robotinternetowy.RobotinternetowyApp.class).getContext().getActionMap(RobotinternetowyAboutBox.class, this);
